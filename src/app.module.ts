...
@Module({
  imports: [PrismaModule,AuthModule, UserModule, 
    UserPreferenceModule, EventModule, TicketModule, 
    CarpoolModule, FeedModule, PostModule, 
    CommunityModule, TransactionModule, MediaModule, 
    SearchModule, NotificationModule, UserFollowModule,
    CommunityFollowModule, TransactionReferenceModule,EventTicketModule,
    MailModule, CarpoolModule,CronModule,DeviceTokenModule, CarpoolQueueModule,
    MessageModule,RedisModule,GuardsModule,
    ConfigModule
      .forRoot({
